...
def identity_block(A_prev, filters):
    ...
    F11, F3, F12 = filters
    layer_1 = K.layers.Conv2D(filters=F11, (1, 1), padding='same',
                              kernel_initializer=init)(A_prev)
    layer_1 = K.layers.BatchNormalization(axis=-1)(layer_1)
    layer_1 = K.layers.Activation('relu')(layer_1)

    layer_2 = K.layers.Conv2D(filters=F3, (3, 3), padding='same',
    ...
    layer_3 = K.layers.Conv2D(filters=F12, (1, 1), padding='same',
